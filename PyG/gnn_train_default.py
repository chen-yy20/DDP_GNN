...
def train(model, train_idx, model_name): 
    ...
    for epoch in range(1):
        ...
        with open("PyG/Result/Default_{}_{}.txt".format(args.dataset, args.model), "a") as text_file:
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--trainer",
        default= 32,
        help="For default configuration, we set all the cores in one socket as trainer cores.",
    )
    ...
    # For a bi-socket machine, the first socket is used for trainer, the second socket is used for loader, and loader_num is 2
